...
const VelocityDistanceChart = observer(() => {
  ...
  const handleMetricChange = (
    ...
    newMetric: "v_swim" | "si" | "ie" | "stroke_length" | null
  ) => {
    if (newMetric !== null) {
  ...
  const chartTitles = {
    ...
    si: "Stroke Index vs. Distance",
    ie: "IE Ratio vs. Distance",
  ...
  return (
    ...
    >
      <Typography variant="h6" fontWeight="bold" gutterBottom>
        {chartTitles[swimStore.velocityChartYAxis]}
      </Typography>
      <ToggleButtonGroup
      ...
      >
        <ToggleButton value="v_swim" aria-label="velocity">
          Velocity
        </ToggleButton>
        <ToggleButton value="Stroke Index (SI)" aria-label="stroke index">
          Stroke Index
        </ToggleButton>
        <ToggleButton value="IE Ratio" aria-label="ie ratio">
          IE Ratio
        </ToggleButton>
        <ToggleButton value="stroke_length" aria-label="stroke length">
          Stroke Length
        </ToggleButton>
      </ToggleButtonGroup>
      <div ref={chartRef}>
