...
import { Box, Card, Typography, TextField, Button, keyframes, FormControlLabel, Checkbox, Collapse } from '@mui/material';
...
const RegistrationScreen = observer(() => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setError('');
    try {
      await swimStore.register(name, email, password, stravaClientId, stravaClientSecret);
      navigate('/');
    } catch (err: any) {
