...
import { Box, Typography, Paper, Grid, useMediaQuery, useTheme, Stack, Accordion, AccordionSummary, AccordionDetails, Tooltip, IconButton } from '@mui/material';
...
const Dashboard = observer(() => {
  ...
  return (
    <Box ref={dashboardRef} sx={{ p: { xs: 2, sm: 3 }, mx: 'auto' }}>
      ...
      {showFilters && <FilterCard sx={{ mb: 4 }} />}
      {isMobile ? (
